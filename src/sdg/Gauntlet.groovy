...
def logJira(jiraArgs) {
    defaultFields = [site:'sdg-jira',project:'GTSQA', assignee:'JPineda3', issuetype:'Bug', components:"Testing", description:"Issue exists in recent build."]
