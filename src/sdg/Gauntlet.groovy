        ...
        cls = { String board ->
            ...
            stage("Run MATLAB Toolbox Tests") {
                ...
                {   
                    ...
                    {
                        createMFile()
                        sh 'IIO_URI="ip:'+ip+'" board="'+board+'" elasticserver='+gauntEnv.elastic_server+' /usr/local/MATLAB/'+gauntEnv.matlab_release+'/bin/matlab -nosplash -nodesktop -nodisplay -r "run(\'matlab_commands.m\');exit()" printenv failures'
                        junit testResults: '*.xml', allowEmptyResults: true
                    }
                }
            }
